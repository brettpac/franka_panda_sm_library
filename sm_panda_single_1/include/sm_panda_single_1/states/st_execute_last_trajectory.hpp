...
// STATE DECLARATION
struct StExecuteLastTrajectory : smacc2::SmaccState<StExecuteLastTrajectory, SmPandaSingle1>
{
  ...
  typedef boost::mpl::list<
      Transition<EvCbSuccess<CbExecuteLastTrajectory, OrArm>, StPause11, SUCCESS>, 
