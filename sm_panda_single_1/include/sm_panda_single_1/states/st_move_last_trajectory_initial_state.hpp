...
// STATE DECLARATION
struct StMoveLastTrajectoryInitialState : smacc2::SmaccState<StMoveLastTrajectoryInitialState, SmPandaSingle1>
{
  ...
  typedef boost::mpl::list<
      Transition<EvCbSuccess<CbMoveLastTrajectoryInitialState, OrArm>, StPause9, SUCCESS>,
