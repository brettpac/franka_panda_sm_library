...
// STATE DECLARATION
struct StMoveKnownState2 : smacc2::SmaccState<StMoveKnownState2, SmPandaSingle1>
{
  ...
  static void staticConfigure()
  {
    ...
    std::string filepath = "config/move_group_client/known_states/control_authority_posture3.yaml";
